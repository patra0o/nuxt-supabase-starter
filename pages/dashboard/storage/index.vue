  ...
  <div class="w-full mx-auto my-16 space-y-[30px] max-w-7xl">
      ...
      <div class="col-span-12 md:col-span-6 lg:col-span-5 xl:col-span-3">
        <div class="md:border-r border-gray-200 dark:border-stone-800 md:h-[75vh] pr-0 md:pr-3 flex flex-col gap-3">
          ...
          <template v-else>
            ...
            }" v-for="(item, index) in fileList" :key="index" @click="seeDetail(item)">
    ...
    <div class="relative flex justify-center items-center h-[300px]" v-if="!loadingState.get && fileList?.length <= 0">
      <div class="flex flex-col justify-center items-center relative z-10 gap-2">
        ...
        <h2 class="text-2xl font-bold">Storage is empty, <span class="underline cursor-pointer"
            @click="selectFile">add</span> new file</h2>
      </div>
      <div class="absolute left-0 top-0 flex w-full h-full items-center justify-center"
        v-if="$colorMode.value === 'dark'">
        <img src="/gradient-pattern-square.webp" class="h-[200px] " alt="">
